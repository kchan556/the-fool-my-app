...
export default function LoginPage() {
  ...
  const handleDiscordLogin = async () => {
    ...
    try {
      ...
      // OAuthリダイレクトが発生するため、ここには到達しなぁE
    } catch {
      setError('ログインに失敗しました。もぁE��度お試しください、E);
    } finally {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        <div className="bg-gray-800 p-8 rounded-lg max-w-md w-full mx-4 text-center">
          <h1 className="text-2xl font-bold text-white mb-4">開発モーチE/h1>
          <p className="text-gray-400 mb-6">
            認証スキチE�Eモードが有効です、E
            <br />
            自動的にモチE��ユーザーとしてログインされます、E
          </p>
          <Link
            href="/entrance"
