...
export const CardsDialog = () => {
  ...
  const handleTimeExpiration = useCallback(() => {
    ...
    // 譎る俣蛻・ｌ縺ｧ遒ｺ螳壹＆繧後◆譎ゅ∬ｶｳ繧翫↑縺・・縺ｮ繧ｫ繝ｼ繝峨ｒ蜈磯ｭ縺九ｉ閾ｪ蜍輔〒驕ｸ謚槭☆繧・
    confirmSelection([
      ...selection,
      ...(cards
        ?.map(card => card.id)
  ...
  // cards繧剃ｾ晏ｭ倬・蛻励↓霑ｽ蜉縺吶ｋ縺薙→縺ｧ縲√ヰ繝・メ蜃ｦ逅・〒 isOpen 縺・false 縺ｫ縺ｪ繧峨↑縺上※繧・
  // 譁ｰ縺励＞繝繧､繧｢繝ｭ繧ｰ縺碁幕縺九ｌ縺滓凾縺ｫ繧ｿ繧､繝槭・繧偵Μ繧ｻ繝・ヨ縺吶ｋ
  useEffect(() => {
    if (isOpen && isSelector && timeLimit) {
      // 譌｢蟄倥・繧ｿ繧､繝槭・繧偵け繝ｪ繧｢縺励※譁ｰ縺励＞繧ｿ繧､繝槭・繧偵そ繝・ヨ
