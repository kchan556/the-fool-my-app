...
export const ChainOverlay: React.FC<ChainOverlayProps> = ({ isSmall = false }) => {
  ...
  // 対角線上の四角形座標を計算
  // direction によって左上から右下、または右上から左下への座標を生成
  ...
  // 2本の対角線（バッテン：左上から右下、右上から左下）
  const diagonal1 = getDiagonalPositions('leftTopToRightBottom');
  const diagonal2 = getDiagonalPositions('rightTopToLeftBottom');
