...
interface LoadingOverlayProps {
  ...
  // カスタム終了処理（デフォルトは /entrance へリダイレクト）
  onExit?: () => void;
}
...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({
  ...
  return (
    <dialog
      ref={dialogRef}
      className="bg-transparent backdrop:bg-black/70 backdrop:backdrop-blur-sm max-w-md w-full p-0 rounded-lg overflow-visible fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 m-0 border-none outline-none"
    >
